...
<Quiz
  id="q-write-vs-append"
  question="Which file mode should you use when you want to keep the existing file contents and add new text at the end?"
  options={[
    '"a"',
    '"w"',
    '"r"',
  ...
  correctIndex={0}
  explanation="`a` appends to the end of the file. `w` overwrites the existing contents."
/>
