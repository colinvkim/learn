...
<Quiz
  id="q-type-hints-runtime"
  question="What do Python type hints change at runtime by themselves?"
  options={[
    "Nothing — they mainly help people and tools like mypy",
    "They automatically reject wrong argument types at runtime",
    "They compile Python into a statically typed binary",
  ]}
  correctIndex={0}
  explanation="Type hints are optional annotations. They improve readability and tooling, but Python does not enforce them automatically at runtime."
/>
