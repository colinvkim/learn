...
<Quiz
  id="q-remote-vs-push"
  question="What changes after you run git remote add origin ...?"
  options={[
    "The local repository now knows the remote URL, but no commits have been uploaded yet",
    "The current branch is immediately published to GitHub",
    "GitHub creates a pull request automatically",
  ]}
  correctIndex={0}
  explanation="Adding a remote only stores connection information in the local repo. Uploading commits still requires `git push`."
/>
