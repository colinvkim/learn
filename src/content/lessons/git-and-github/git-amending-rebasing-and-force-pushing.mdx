...
<Note title="Force pushing requires a remote">
  <p>Force pushing only matters once you have pushed to a remote. If you are still working locally, normal commits and resets are enough. Remote pushing and force pushing are covered in the GitHub lessons.</p>
</Note>
