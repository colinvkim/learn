...
<Quiz
  id="q-pr-updates"
  question="What happens if you push more commits to the branch after opening a pull request?"
  options={[
    "The pull request updates to include the new commits automatically",
    "The pull request closes and you must open a new one",
    "GitHub moves the new commits directly onto the base branch",
  ]}
  correctIndex={0}
  explanation="A pull request tracks the source branch. New commits pushed to that branch appear in the same pull request."
/>
