...
<Quiz
  ...
  options={[
    "When Git cannot automatically combine overlapping changes and needs a person to choose the result",
    "Whenever two branches have any different commits",
    "Whenever you merge into main instead of creating a new branch",
  ]}
  correctIndex={0}
  explanation="Different commits alone do not create a conflict. Conflicts happen when Git cannot safely decide how overlapping changes should be combined."
/>
