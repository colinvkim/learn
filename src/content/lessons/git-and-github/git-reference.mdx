...
GitHub CLI (`gh`) simplifies authentication, SSH key setup, and remote configuration in one interactive command. See the [connecting lesson](/courses/git-and-github/github-connecting-a-local-repository-to-github) for details.
