...
gh repo create         # create a GitHub remote and push in one step
gh auth status         # check current authentication status
```

GitHub CLI (`gh`) simplifies authentication, SSH key setup, and remote configuration compared to manual steps. See the connecting lesson for details.
