...
<Callout title="This course focuses on zsh and bash">
  <p>
    The primary commands in this course target zsh and bash, which behave almost
    identically for the basics. When a command or syntax differs in PowerShell
    or Command Prompt, a callout will show the equivalent. The mental model —
    where you are, what files are here, what command to run — is the same across
    all shells.
  </p>
</Callout>
