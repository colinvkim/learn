...
<Quiz
  id="q-less-best-use"
  question="Which command is usually the best first choice for reading a large text file without dumping the whole thing into the terminal at once?"
  options={[
    "less",
    "cat",
    "stat",
  ...
  correctIndex={0}
  explanation="`less` lets you page through large files interactively. `cat` prints everything immediately, which is usually worse for long files."
/>
