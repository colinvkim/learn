...
<Quiz
  id="q-find-vs-grep"
  question="You know a file contains the word TODO somewhere inside it, but you do not know which file. Which tool is the better fit first?"
  options={[
    "grep",
    "find",
    "which",
  ...
  correctIndex={0}
  explanation="`grep` searches file contents for matching text. `find` is mainly for locating files by name, path, or metadata."
/>
