...
<Note title="Tailwind and framework approaches">
  <p>
    Tailwind CSS takes a different approach: instead of writing component CSS, you compose small utility classes directly in HTML. Behind the scenes, it uses the same CSS fundamentals you have learned: cascade layers, custom properties for tokens, responsive constraints, and state. The next lessons explore Tailwind as an alternative to writing all CSS from scratch.
  </p>
</Note>
