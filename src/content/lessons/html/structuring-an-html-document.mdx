...
<Quiz
  id="q-html-head-vs-body"
  question="Which item belongs in the `<head>` rather than the `<body>`?"
  options={[
    "The page title shown in the browser tab",
    "The visible main heading the user reads in the page",
    "The navigation links users click in the document",
  ]}
  correctIndex={0}
  explanation="The `<head>` holds document metadata such as `<title>`. Visible document content like headings and navigation belongs in the `<body>`."
/>
