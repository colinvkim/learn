...
<Quiz
  id="q-html-capstone-page-thinking"
  question="Which choice best shows good page-level HTML thinking for a small multi-page site?"
  options={[
    "Keep a consistent site shell, give each page a clear job, and make the main content unique per page",
    "Put most content on the homepage and use other pages mainly as copies with different filenames",
    "Design each page as an isolated fragment first and worry about navigation and titles later",
  ]}
  correctIndex={0}
  explanation="Strong HTML sites are sets of clear documents: shared structure where consistency helps, unique main content where page purpose changes, and navigation that connects the whole site."
/>
