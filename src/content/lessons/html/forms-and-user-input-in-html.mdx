...
<Warning title="Placeholder text is not a label">
  <p>
    Use placeholder text only for small extra hints when needed. The actual field name should still be a real <code>&lt;label&gt;</code> so the control stays understandable and accessible.
  </p>
</Warning>
