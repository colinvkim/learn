...
<Tip title="Start with native HTML before reaching for ARIA">
  <p>
    If HTML already has an element for the job, use it. Links, buttons, form controls, tables, and landmarks come with meaning and behavior built in, which is usually more reliable than recreating them with generic elements.
  </p>
</Tip>
