...
<Note title="HTML and the DOM are related, but not identical">
  <p>
    HTML is the source document you write. The DOM is the structured tree the browser builds from that HTML. This course focuses on writing good HTML; the JavaScript course covers how code works with the DOM later.
  </p>
</Note>
