...
<Quiz
  id="q-html-links-vs-buttons"
  question="Which element should you use for 'Read class details' when it takes the user to another page?"
  options={[
    "<a>",
    "<button>",
    "<div>",
  ...
  correctIndex={0}
  explanation="Use a link when the user is going somewhere. Buttons are for actions on the current page."
/>
