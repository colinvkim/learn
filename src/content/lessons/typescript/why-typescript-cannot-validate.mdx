...
<Quiz
  id="q-trust-boundary"
  question="Where should you validate external data in a TypeScript application?"
  options={[
    "At the trust boundary where untyped data enters the app",
    "Only deep inside business logic after the data has been passed around",
    "Nowhere, because type annotations already guarantee the shape",
  ]}
  correctIndex={0}
  explanation="Validate as the data enters your system, then work with typed values internally. That keeps the unsafe boundary small."
/>
