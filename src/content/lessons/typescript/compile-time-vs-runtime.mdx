...
<Quiz
  id="q-compile-vs-runtime"
  question="Which statement is true?"
  options={[
    "Compile time is when TypeScript checks types; runtime is when JavaScript actually executes",
    "Compile time is when the browser runs your program for the first time",
    "Runtime is when TypeScript reads your annotations before emitting JavaScript",
  ]}
  correctIndex={0}
  explanation="TypeScript's checker runs before execution. Once the code is running, you are in JavaScript runtime land."
/>
